...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: "15:05", title: "Ferry Santorini → Milos — SUPER JET 2", type: "transit", fixed: true,
      ...
      booking: { label: "Ferry", value: "Confirmed · Club seats", source: "SeaJets email" },
    ...
    { date: "2026-10-06", start: null, title: "Pick up the rental car — Adamantas", type: "transit", fixed: false,
      ...
      note: "Straight off the 5:10 PM boat, at or near the ferry port. Still not booked — worth locking in, and tell them the arrival is an evening one so the desk is staffed.",
      booking: { label: "Rental car", value: "Not booked yet", source: "to arrange" },
      headsup: ["Car still to book", "Evening pick-up — confirm desk hours"] },
    ...
    { date: "2026-10-08", start: "11:20", title: "Ferry Adamantas → Santorini — SeaJets", type: "transit", fixed: true,
      ...
      website: "https://www.seajets.com/",
      note: "Arrives Santorini 1:15 PM. First leg of a 6 hr 5 min journey to Heraklion — $115.36 per person for the through ticket. Still to book, and now the only unbooked leg of the trip. Book both legs as one connected itinerary: that is what carries the guaranteed connection, which two separate tickets would not.",
      booking: { label: "Ferry", value: "Itinerary found — not booked yet", source: "SeaJets" },
      headsup: ["Still to book", "Book both legs together"] },
    ...
    { date: "2026-10-08", start: "15:45", title: "Ferry Santorini → Heraklion — SeaJets", type: "transit", fixed: true,
      address: "Athinios Port, Santorini",
      website: "https://www.seajets.com/",
      note: "Arrives Heraklion 5:25 PM — 1 hr 40 min across open sea, the most exposed crossing of the trip and the tail of a six-hour travel day. This leg sells Silver, Economy, Club and Platinum: Club is the same call as the Milos boat (wider seats, calmer cabin, interior with no window), and Platinum adds a quieter lounge and service upstairs. If the sea is up, lower and mid-ship rides better than the top deck.",
      headsup: ["Connection guaranteed by SeaJets", "Club or Platinum — long day by then"] },
