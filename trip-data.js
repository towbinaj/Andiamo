...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: null, title: "Pick up the rental car — Adamantas", type: "transit", fixed: false,
      ...
      note: "Straight off the 5:10 PM boat, at or near the ferry port. The last unbooked thing on the trip — worth locking in, and tell them the arrival is an evening one so the desk is staffed. Two full days of Milos depend on it.",
      booking: { label: "Rental car", value: "Not booked yet", source: "to arrange" },
      headsup: ["The one thing left to book", "Evening pick-up — confirm desk hours"] },
    ...
    { date: "2026-10-08", start: "15:45", title: "Ferry Santorini → Heraklion — CHAMPIONS LEAGUE JET 2", type: "transit", fixed: true,
      ...
      booking: { label: "Ferry", value: "Confirmed · Platinum seats", source: "SeaJets email" },
