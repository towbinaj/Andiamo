...

{
  ...
  events: [
    ...
    { date: "2026-10-05", start: "13:00", title: "Bus or taxi Oia → Fira, collect the car", type: "transit", fixed: true,
      address: "Fira, Santorini 84700",
      note: "Buses run Oia to Fira every half hour or so for a couple of euros, 25 minutes; a taxi is quicker and about €25. Pick the car up in Fira — the afternoon is all in the south and there's no bus worth having down there.",
      booking: { label: "Rental car", value: "Not booked yet", source: "to arrange" },
      headsup: ["Car still to book — one day only"] },
    { date: "2026-10-05", start: "14:15", title: "Akrotiri — the buried Minoan city", type: "ticket", fixed: true,
      ...
      note: "A Bronze Age town buried by the eruption and dug out under a modern roof: streets, drains, two- and three-storey houses still standing. Open daily 8:00–18:30 in the first half of October, so there's no rush. Allow an hour and a half.",
    ...
    { date: "2026-10-05", start: null, title: "Back to Imerovigli for sunset", type: "transit", fixed: false,
      note: "About 25 minutes north. Keep the car overnight — it's easier than a second pick-up, and drop it in Fira in the morning." },
    ...
    { date: "2026-10-06", start: null, title: "Lunch in Fira", type: "meal", fixed: false,
      address: "Fira, Santorini 84700",
      note: "Last meal on Santorini. Back to Kapari by about 1:30 to collect the bags." },
