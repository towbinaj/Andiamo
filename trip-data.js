...

{
  ...
  events: [
    ...
    { date: "2026-10-07", start: null, title: "Klima", type: "sight", fixed: false,
      ...
      note: "The picture of Milos: a single row of syrmata along the water below Tripiti, painted every colour. It faces west, so late afternoon is when it lights up — which is why it's last. The road down is steep and single-track. Dinner is fifteen minutes away at Adamas, so there's no rush to leave before the light goes.",
    ...
    { date: "2026-10-07", start: "19:30", title: "Dinner — O! Hamos!, Adamas", type: "meal", fixed: true, qty: 2,
      ...
      note: "Akrotiri being shut, the goat moves here — and the geography improves, because Klima sits just below Tripiti and Adamas is fifteen minutes away, not thirty. A family farm taverna with hand-written menus: wild goat in lemon-mustard sauce, chickpeas in a clay pot, pitarakia, cheese from their own goats. After Yialos and octopus at lunch, this is the meal that makes the day vary. It takes no reservations — you give your name at the door and wait with a drink at the beach bar across the road — so come at half seven, straight from Klima, and the wait is short in October. Worth checking it's still open this late in the season.",
