...

{
  ...
  events: [
    ...
    { date: "2026-10-05", start: "13:00", title: "Collect the car — in Oia", type: "transit", fixed: true,
      address: "Oia, Santorini 84702",
      note: "Rent from an agency with offices in both Oia and Fira, and the day has no backtracking in it: you finish the walk in Oia, pick the car up there, drive south, and hand it back in Fira the same evening. Five and a half hours, which is a single day's hire at any agency — and no car to park overnight in a village where nobody can tell you whether there's a space.",
      booking: { label: "Rental car", value: "Not booked yet", source: "to arrange" },
      headsup: ["Oia 13:00, back in Fira 18:15", "Check the agency's own document terms"] },
    ...
    { date: "2026-10-07", start: "13:00", title: "Lunch — Medusa, Mandrakia", type: "meal", fixed: true,
      ...
      note: "Mandrakia is a fishing hamlet of syrmata — the garage-doored boathouses cut into the rock, painted whatever colour the fishermen had — and Medusa sits right over the water beside them, known for seafood and octopus. It was already a stop on this loop, so eating here turns a fifteen-minute look into the meal of the day. Open from noon.",
      headsup: ["Stop here rather than driving on to Plaka"] },
    ...
    { date: "2026-10-07", start: null, title: "Catacombs of Milos", type: "ticket", fixed: false,
      ...
      headsup: ["Closed Tuesdays — Wednesday is fine"] },
    ...
    { date: "2026-10-07", start: null, title: "Klima", type: "sight", fixed: false,
      ...
      note: "The picture of Milos: a single row of syrmata along the water below Tripiti, painted every colour. It faces west, so late afternoon is when it lights up — which is why it's last. The road down is steep and single-track.",
      headsup: ["Best light late in the day"] },
    { date: "2026-10-07", start: null, title: "Dinner — Akrotiri, for the goat", type: "meal", fixed: false,
      address: "Akrotiri, Pollonia, Milos 84800",
      website: "https://akrotirimilos.gr/",
      note: "Back across the island, about 30 minutes from Klima. After Yialos and a lunch of octopus over the water, the last thing this night needs is a third plate of fish — so: katsikomakaronada, the Milos dish. Handmade egg pasta like pappardelle, wild goat from Chalakas slow-cooked in a clay pot with cinnamon and cloves, grated Mileiko cheese over it. Enalion and Armenaki are the alternatives if you'd rather have the fish after all; both are traditional and both are good.",
      headsup: ["Book it — the day ends late"] },
