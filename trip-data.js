...

{
  ...
  events: [
    ...
    { date: "2026-10-08", start: "11:20", title: "Ferry Adamantas → Santorini — SeaJets", type: "transit", fixed: true,
      ...
      website: "https://www.seajets.com/",
      note: "Arrives Santorini 1:15 PM. First leg of a 6 hr 5 min journey to Heraklion — $115.36 per person for the through ticket. Still to book, and now the only unbooked leg of the trip.",
      booking: { label: "Ferry", value: "Itinerary found — not booked yet", source: "SeaJets" },
      headsup: ["Still to book"] },
