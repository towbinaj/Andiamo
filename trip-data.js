...

{
  ...
  events: [
    ...
    { date: "2026-10-05", start: "14:00", title: "Collect the car — in Oia", type: "transit", fixed: true,
      address: "Oia, Santorini 84702",
      note: "Rent from an agency with offices in both Oia and Fira — Vazeos has both — and the day has no backtracking in it: you finish the walk in Oia, pick the car up there, drive south, and hand it back in Fira the same evening. Booked from 13:00 through to 21:00, with the agency told you may run late: one day's hire covers anything under 24 hours, so the wide window costs nothing and pads both ends. Expect to collect nearer two in practice — the walk lands in Oia about eleven and Ammoudi is 300 steps down, an unhurried lunch, 300 back up — but if the morning runs fast, the car is there from one and Akrotiri gains an hour. The late return keeps Metaxi Mas open; hand the keys back at six if Monday ends at Parea instead.",
      booking: { label: "Rental car", value: "Not booked yet — the last one outstanding", source: "to arrange" },
      headsup: ["Booked 13:00–21:00, collecting nearer 14:00", "Ask for an automatic", "Confirm late/key-drop return"] },
