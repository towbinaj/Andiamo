...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: null, title: "Dinner in Pollonia", type: "meal", fixed: false,
      note: "The waterfront is a short walk from Phos and you'll be checked in around 6:00, so an early table is easy. Gialos has been on the water here for twenty years — anchovies, taramosalata, fish carpaccio — and Enalion puts its tables closer to the sea still. Either is the right first night." },
    ...
    { date: "2026-10-07", start: null, title: "Mandrakia", type: "sight", fixed: false,
      address: "Mandrakia, Milos 84800",
      note: "A fishing hamlet of syrmata — the garage-doored boathouses cut into the rock, painted in colours that were whatever paint the fishermen had. Fifteen minutes and a taverna if the timing is right." },
    ...
    { date: "2026-10-07", start: null, title: "Lunch in Plaka", type: "meal", fixed: false,
      address: "Plaka, Milos 84800",
      note: "The island capital, up on its ridge — lanes too narrow for cars, so park below and walk up." },
    ...
    { date: "2026-10-07", start: null, title: "Catacombs of Milos", type: "ticket", fixed: false,
      ...
      note: "Early Christian burial galleries cut into the hillside at Tripiti, among the oldest in the world and far less visited than they deserve. They close early — check before you go, generally mornings to mid-afternoon.",
      headsup: ["Closes early afternoon — go before Klima"] },
    ...
    { date: "2026-10-07", start: null, title: "Dinner — Armenaki", type: "meal", fixed: false,
      address: "Armenaki, Pollonia, Milos 84800",
      note: "Back across the island, about 30 minutes from Klima, and the night to eat properly: Armenaki is called the best fish tavern on Milos — seabass tartare, seafood risotto, Cycladic cooking done seriously. Worth booking ahead of a day that ends late.",
      headsup: ["Book it"] },
