...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: null, title: "Drive to Fira, drop the car", type: "transit", fixed: false,
      address: "Fira, Santorini 84700",
      note: "Ten minutes down from Imerovigli. Handing it back in Fira puts you on the museum's doorstep and saves hunting for parking, which in Fira is its own event." },
    ...
    { date: "2026-10-06", start: null, title: "Lunch in Fira", type: "meal", fixed: false,
      address: "Fira, Santorini 84700",
      note: "Last meal on Santorini. Taxi or bus back up to Kapari by about 1:30 to collect the bags — the car will be gone by then." },
