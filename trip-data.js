...

{
  ...
  events: [
    ...
    { date: "2026-10-05", start: "14:00", title: "Collect the car — in Oia", type: "transit", fixed: true,
      address: "Oia, Santorini 84702",
      note: "Rent from an agency with offices in both Oia and Fira — Vazeos has both — and the day has no backtracking in it: you finish the walk in Oia, pick the car up there, drive south, and hand it back in Fira the same evening. Two o'clock rather than one: the walk lands you in Oia about eleven, and Ammoudi takes longer than it looks — 300 steps down, an unhurried lunch on the water, 300 back up — which puts you at the top nearer two than one. Book the return for 21:00, not 18:15. Anything under 24 hours is one day's hire either way, so the later slot costs nothing and keeps Metaxi Mas possible; hand the keys back at six if you end up at Parea instead. The thing to confirm when booking is that the Fira office takes a late or key-drop return.",
      booking: { label: "Rental car", value: "Not booked yet — the last one outstanding", source: "to arrange" },
      headsup: ["Oia 13:00, return booked to 21:00", "Ask for an automatic", "Confirm late/key-drop return"] },
