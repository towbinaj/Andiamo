...

{
  ...
  days: [
    ...
    { date: "2026-10-04", title: "Arrive Santorini · Imerovigli" },
    { date: "2026-10-05", title: "Full day on Santorini" },
    { date: "2026-10-06", title: "Santorini → Milos" },
    { date: "2026-10-07", title: "Milos by car" },
    { date: "2026-10-08", title: "Milos → Santorini → Heraklion" },
    { date: "2026-10-09", title: "Heraklion & Knossos" },
    { date: "2026-10-10", title: "Crete — day open" },
  ...
  events: [
    /* ---------------------------- Sat, Oct 3 — outbound ---------------------------- */
    { date: "2026-10-03", start: null, title: "Depart Cincinnati — CVG", type: "flight", fixed: false,
      note: "Overnight travel to Greece. Flight numbers and connections aren't recorded here yet — add them once ticketed.",
      headsup: ["Flight details still to add"] },

    /* ---------------------------- Sun, Oct 4 — arrive Santorini ---------------------------- */
    { date: "2026-10-04", start: "08:00", title: "Arrive Santorini — JTR", type: "flight", fixed: true,
      note: "Morning arrival on Santorini." },
    { date: "2026-10-04", start: null, title: "Transfer to Kapari Natural Resort", type: "transit", fixed: false,
      ...
      note: "Included with the room rate — the hotel meets you and drives up to Imerovigli (~20 min)." },
    { date: "2026-10-04", start: null, title: "Check in — Kapari Natural Resort", type: "sight", fixed: false,
      ...
      note: "Premium Loft with Balcony & Caldera View. Breakfast and the airport transfer are included; the rate is nonrefundable. Rooms are ready at 3:00 PM, and the hotel will hold luggage until then.",
    ...
    { date: "2026-10-08", start: null, title: "Check in — Aquila Atlantis Hotel", type: "sight", fixed: false,
      ...
      note: "Double Business Room with breakfast, Oct 8–11.",
      booking: { label: "Booking", value: "Confirmed", source: "hotel confirmation email" } },
    ...
    { date: "2026-10-09", start: null, title: "Day not planned yet — Crete", type: "sight", fixed: false,
      note: "Expected priorities: the Palace of Knossos and the Heraklion Archaeological Museum, which hold the same story between them — the museum has the frescoes and the finds, the site has the rooms they came from." },
    { date: "2026-10-09", start: null, title: "Dinner", type: "meal", fixed: false,
      note: "No reservation yet." },

    /* ---------------------------- Sat, Oct 10 — Crete ---------------------------- */
    { date: "2026-10-10", start: null, title: "Day not planned yet — Heraklion or farther afield", type: "sight", fixed: false,
      note: "Still undecided: stay around Heraklion, or make this the bigger Crete day (a drive west, or out to a site or beach)." },
    ...
    { date: "2026-10-11", start: null, title: "Breakfast, then check out", type: "meal", fixed: false,
      address: "2 Ygias Street, Heraklion 71202, Crete",
      note: "Breakfast is included at the Aquila Atlantis." },
    { date: "2026-10-11", start: null, title: "Return journey", type: "flight", fixed: false,
      note: "Flights home aren't recorded here yet — add them once ticketed.",
      headsup: ["Flight details still to add"] },
  ],
},
