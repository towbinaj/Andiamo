...

{
  ...
  events: [
    /* ---------------------------- Sat, Oct 3 — outbound ---------------------------- */
    { date: "2026-10-03", start: "11:35", title: "Cincinnati → New York — CVG ► JFK", type: "flight", fixed: true,
      note: "Delta 5096 · Delta Comfort · fare class SU · CRJ-900 · arrives JFK 1:40 PM, Terminal 4. Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · seats open", source: "Delta app" },
      headsup: ["1 hr 30 min to connect at JFK"] },
    { date: "2026-10-03", start: "15:10", title: "New York → Athens — JFK ► ATH", type: "flight", fixed: true,
      note: "Delta 202 · Delta Comfort · fare class SU · about 9 hr 40 min · arrives Athens 7:50 AM on Sun, Oct 4. Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · seats open", source: "Delta app" },
    ...
    { date: "2026-10-04", start: "07:50", title: "Land in Athens — ATH", type: "flight", fixed: true,
      ...
      note: "Delta 202 lands at 7:50 AM. About 4 hr 25 min before the Santorini flight — long enough to clear passport control (this is your Schengen entry point), collect and re-check bags if they aren't through-tagged, and have a slow breakfast.",
      headsup: ["Passport control here, not Santorini"] },
    { date: "2026-10-04", start: "12:15", title: "Athens → Santorini — ATH ► JTR", type: "flight", fixed: true,
      note: "Flight 342 · fare class E · arrives Santorini 12:52 PM. Almost certainly Sky Express (GQ 342) rather than Delta metal — Delta doesn't fly Greek domestic routes itself, which is what the airport-controlled seats point to. Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · airport-controlled seats", source: "Delta app" },
      headsup: ["Seats assigned at check-in", "Confirm the operating carrier"] },
    { date: "2026-10-04", start: null, title: "Transfer to Kapari Natural Resort", type: "transit", fixed: false,
      ...
      note: "Included with the room rate — the hotel meets you and drives up to Imerovigli (~20 min). Landing at 12:52 PM puts you at Kapari around 1:45 PM." },
    { date: "2026-10-04", start: null, title: "Check in — Kapari Natural Resort", type: "sight", fixed: false,
      ...
      note: "Premium Loft with Balcony & Caldera View. Breakfast and the airport transfer are included; the rate is nonrefundable. Rooms are ready at 3:00 PM — roughly an hour after you arrive, so the luggage hold is a short one.",
      booking: { label: "Booking", value: "Confirmed", source: "hotel confirmation email" },
      headsup: ["Check-in 3:00 PM — bags held earlier", "Nonrefundable rate"] },
    ...
    { date: "2026-10-06", start: "11:00", title: "Check out — Kapari Natural Resort", type: "sight", fixed: true,
      address: "Imerovigli, Santorini 84700",
      note: "Check-out is by 11:00 AM.",
      headsup: ["Check out by 11:00 AM"] },
    { date: "2026-10-06", start: null, title: "Transfer to Athinios ferry port", type: "transit", fixed: false,
      address: "Athinios Port, Santorini",
      note: "~25 min down the switchbacks from Imerovigli. Arrange the car with the hotel the night before — the port road backs up before a sailing.",
      headsup: ["Ferries leave from Athinios, not the old port"] },
    { date: "2026-10-06", start: null, title: "Ferry Santorini → Milos — SeaJets", type: "transit", fixed: false,
      address: "Athinios Port, Santorini",
      website: "https://www.seajets.com/",
      note: "The ~2-hour sailing to Adamantas. Club seats are €103.70 pp against €97.70 for Silver — Club is the better seat for €6. Sailing time isn't locked in yet.",
      booking: { label: "Ferry", value: "Fare found — not booked yet", source: "SeaJets" },
      headsup: ["Book the sailing", "Be at the port ~45 min early"] },
    { date: "2026-10-06", start: null, title: "Pick up the rental car — Adamantas", type: "transit", fixed: false,
      address: "Adamantas, Milos 84801",
      note: "Pick-up at or near the ferry port. Not booked yet — worth locking in, October stock on Milos is thin.",
      booking: { label: "Rental car", value: "Not booked yet", source: "to arrange" },
      headsup: ["Car still to book"] },
    ...
    { date: "2026-10-06", start: null, title: "Dinner in Pollonia", type: "meal", fixed: false,
      note: "The waterfront in Pollonia is a short walk from the hotel. No reservation yet." },
    ...
    { date: "2026-10-08", start: null, title: "Drive Pollonia → Adamantas & return the car", type: "transit", fixed: false,
      address: "Adamantas, Milos 84801",
      note: "~15–20 min. Target the port by 10:30 AM so the drop-off isn't rushed.",
      headsup: ["At the port by 10:30 AM"] },
    { date: "2026-10-08", start: "11:20", title: "Ferry Adamantas → Santorini — SeaJets", type: "transit", fixed: true,
      address: "Adamantas Port, Milos 84801",
      website: "https://www.seajets.com/",
      note: "Arrives Santorini 1:15 PM. First leg of a 6 hr 5 min journey to Heraklion — $115.36 per person for the through ticket.",
      booking: { label: "Ferry", value: "Itinerary found — not booked yet", source: "SeaJets" } },
    ...
    { date: "2026-10-08", start: "15:45", title: "Ferry Santorini → Heraklion — SeaJets", type: "transit", fixed: true,
      address: "Athinios Port, Santorini",
      website: "https://www.seajets.com/",
      note: "Arrives Heraklion 5:25 PM.",
    ...
    { date: "2026-10-09", start: null, title: "EuSoMII Annual Meeting — Day 1", type: "tour", fixed: false,
      address: "Aquila Atlantis Hotel, 2 Ygias Street, Heraklion 71202, Crete", website: "https://www.eusomii-annualmeeting2026.com/",
      note: "Day 1 of the EuSoMII Annual Meeting, here in the hotel. You only need the sessions you care about — pick them off the final programme and step out for the rest. Being in the venue makes dipping in and out easy.",
      headsup: ["Venue is the hotel — no commute", "Pick your sessions"] },
    { date: "2026-10-09", start: null, title: "Registration & badge", type: "ticket", fixed: false,
      address: "Aquila Atlantis Hotel, 2 Ygias Street, Heraklion 71202, Crete",
      note: "At the venue desk. Times to confirm against the final programme — it may also open the evening before." },
    { date: "2026-10-09", start: null, title: "Knossos & the Archaeological Museum", type: "sight", fixed: false,
      ...
      note: "Your two Crete priorities, and they hold the same story between them — the museum has the frescoes and the finds, the site has the rooms they came from. Knossos is ~20 minutes by taxi, the museum a 10-minute walk from the hotel. Since you don't need every session, these fit around the ones you pick — or split them across the two days." },
    { date: "2026-10-09", start: null, title: "Dinner", type: "meal", fixed: false,
      note: "No reservation yet." },

    /* ---------------------------- Sat, Oct 10 — Crete ---------------------------- */
    { date: "2026-10-10", start: null, title: "EuSoMII Annual Meeting — Day 2", type: "tour", fixed: false,
      address: "Aquila Atlantis Hotel, 2 Ygias Street, Heraklion 71202, Crete", website: "https://www.eusomii-annualmeeting2026.com/",
      note: "Day 2, same venue. Same again — the sessions you want, around the lecture at noon." },
    { date: "2026-10-10", start: "12:00", title: "Your lecture — Joint Lecture 2-1", type: "tour", fixed: true,
      address: "Aquila Atlantis Hotel, 2 Ygias Street, Heraklion 71202, Crete", website: "https://www.eusomii-annualmeeting2026.com/",
      note: "“PACS 3.0 and the Emergence of Workflow Intelligence” — Alexander Towbin, in the noon Joint Lecture session (2-1). The noon slot is what you have; confirm the exact start against the final programme.",
      headsup: ["Noon session — confirm the exact slot"] },
    { date: "2026-10-10", start: null, title: "Afternoon open — Heraklion or farther afield", type: "sight", fixed: false,
      note: "With the lecture done at noon, the rest of the day is yours: whatever's left of Knossos and the museum, the old town and the Venetian harbour, or a drive out for the bigger Crete afternoon you had in mind. The flight home leaves early, so keep it close enough to be back for dinner." },
    { date: "2026-10-10", start: null, title: "Dinner", type: "meal", fixed: false,
      note: "No reservation yet." },

    /* ---------------------------- Sun, Oct 11 — departure ---------------------------- */
    { date: "2026-10-11", start: null, title: "Check out — early start", type: "meal", fixed: false,
      address: "2 Ygias Street, Heraklion 71202, Crete",
      note: "Leave the hotel by about 7:00 AM for the 8:40 flight. Breakfast is included but may not be served that early — worth asking the front desk for a boxed one, or eating at the airport.",
      headsup: ["Ask about early breakfast"] },
    { date: "2026-10-11", start: null, title: "Taxi to Heraklion airport — HER", type: "transit", fixed: false,
      ...
      note: "About 15 minutes from the hotel. Ask the front desk to book it the night before." },
    { date: "2026-10-11", start: "08:40", title: "Heraklion → Athens — HER ► ATH", type: "flight", fixed: true,
      note: "Flight 219 · fare class E · about 40 minutes, landing around 9:20 AM. Almost certainly Sky Express (GQ 219). Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · airport-controlled seats", source: "Delta app" },
      headsup: ["Seats assigned at check-in", "Confirm the operating carrier"] },
    { date: "2026-10-11", start: "13:10", title: "Athens → Boston — ATH ► BOS", type: "flight", fixed: true,
      note: "Delta 241 · Delta Comfort · fare class SU · about 10 hr 40 min · arrives Boston 4:50 PM. Nearly 4 hours in Athens beforehand. Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · seats open", source: "Delta app" } },
    { date: "2026-10-11", start: "20:50", title: "Boston → Cincinnati — BOS ► CVG", type: "flight", fixed: true,
      note: "Delta 5801 · Delta Comfort · fare class SU · E175 from Terminal A · home at 11:21 PM. Times are the current published schedule — confirm in the Fly Delta app closer to the date.",
      booking: { label: "Status", value: "Ticketed · seats open", source: "Delta app" },
      headsup: ["Long layover in Boston — clear customs there"] },
  ],
},
