...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: "17:30", title: "Pick up the rental car — Avance, Adamantas", type: "transit", fixed: true,
      ...
      note: "Avance, a Renault Clio automatic or similar, both ends at Milos Port: 17:30 Tuesday to 10:30 Thursday, €65.45 for the two days with collision damage waiver, theft waiver and a second driver all included at no charge. Bigger than the Ignis that was on the shortlist but still a supermini, so Plaka's lanes and the descent to Klima are fine. The excess is €700 plus VAT — about €870 at risk for a scraped wing on a single-track road — so it's worth asking what an excess reduction costs, and worth checking whether the card you pay with covers rental excess, as several US cards do. Expect a hold on that card at the desk. The second driver is free but only once named on the contract, which happens at the desk, not in the booking.",
      booking: { label: "Rental car", value: "Booked · Clio auto · €65.45", source: "Avance — no reservation number yet" }, codeKey: "greececars",
      headsup: ["No reservation number — chase it", "Confirm someone is at the port at 17:30", "Excess €700 + VAT"] },
    ...
    { date: "2026-10-08", start: "09:45", title: "Drive Pollonia → Adamantas & return the car", type: "transit", fixed: true,
      ...
      note: "Leave Pollonia about 9:45 for a 10:30 drop-off, which is 50 minutes before the boat — and the booking already says Milos Port at both ends, so the car goes back where you'll be standing for the 11:20 sailing. Fill the tank on the way: the stations are around Adamantas, and there's nothing near the port to fix it at the last minute.",
