...

{
  ...
  events: [
    ...
    { date: "2026-10-07", start: "20:30", title: "Dinner — Akrotiri, for the goat", type: "meal", fixed: true, qty: 2,
      address: "Akrotiri, Pollonia, Milos 84800",
      website: "https://akrotirimilos.gr/",
      note: "After Yialos and a lunch of octopus over the water, the last thing this night needs is a third plate of fish — so: katsikomakaronada, the Milos dish. Handmade egg pasta like pappardelle, wild goat from Chalakas slow-cooked in a clay pot with cinnamon and cloves, grated Mileiko cheese over it. Half eight is the right hour: sunset at Klima just after seven, half an hour back across the island, and time to drop the car and wash the day off. Enalion and Armenaki are the alternatives if you'd rather the fish after all.",
      headsup: ["Sunset at Klima first, then 30 min back"] },
