...

{
  ...
  events: [
    ...
    { date: "2026-10-05", start: "14:00", title: "Collect the car — in Oia", type: "transit", fixed: true,
      address: "Oia, Santorini 84702",
      note: "Rent from an agency with offices in both Oia and Fira — Vazeos has both — and the day has no backtracking in it: you finish the walk in Oia, pick the car up there, drive south, and hand it back in Fira the same evening. Booked with Vazeos: a Kia Picanto automatic, 13:00 to 22:30, nine and a half hours for €43 all in — fifty for the day less an eight-euro discount, unlimited kilometres, and no charge for a second driver. Nothing is paid yet: the whole €43 is due at pickup, so bring a card. Three things the confirmation doesn't say — what insurance excess applies, whether they hold a deposit, and the fuel policy — are worth asking before you sign. And have the second driver named on the contract at the desk: it costs nothing but only counts if it's written down. One ambiguity to clear up first — the booking lists Kapari as the lodging while the pick-up says Oia, and those are different villages. Confirm you're collecting at the Oia office on foot, so nobody drives a car to Imerovigli while you're six kilometres away in Oia. One day's hire covers anything under 24 hours, so every hour of that window is free, and 21:00 would have been an hour short of the Metaxi Mas evening: winery till six, Exo Gonia by quarter past, a taverna dinner that will not be hurried, then quarter of an hour to Fira. Expect to collect nearer two in practice — the walk lands in Oia about eleven and Ammoudi is 300 steps down, an unhurried lunch, 300 back up — but if the morning runs fast, the car is there from one and Akrotiri gains an hour. Hand the keys back at six if Monday ends at Parea instead; the wide window costs nothing either way.",
      booking: { label: "Rental car", value: "Confirmed · Vazeos · Kia Picanto auto", source: "Oia 13:00 → Fira 22:30" }, codeKey: "greececars",
      headsup: ["€43 due at pickup — card", "Confirm office collection, not hotel delivery", "Add the second driver to the contract", "Ask about excess, deposit and fuel"] },
    ...
    { date: "2026-10-06", start: "17:30", title: "Pick up the rental car — Giourgas, Adamantas", type: "transit", fixed: true,
      address: "Giourgas Rent a Car, Adamantas, Milos 84801",
      website: "https://giourgasrent.com/",
      note: "Giourgas — a family firm running since 2000, office about 0.9 km from Adamas port, open year-round, and they do port pick-up and drop-off at no charge. That last part is the thing worth using: ask them to meet SUPER JET 2 at 17:10 rather than having you walk to the office with the bags, and to take the car back at the port on Thursday morning, where you'll already be standing for the 11:20 boat. Give them the vessel name — a named sailing is what makes an agency wait when SeaJets runs late. Booked 17:30 Tuesday to 10:30 Thursday: about 41 hours, which bills as two days either way, so padding both ends costs nothing. Ask for the Suzuki Ignis automatic off their list: barely longer than a Panda, so it parks in Plaka and on the Klima descent, a little higher off the ground for the beach approach roads, and an automatic for the steep single-track. The 4x4s solve a problem you don't have — the rough tracks are in the far west and the contract voids your insurance on unpaved roads anyway — and the Seat Mii's automatic is the jerky automated-manual kind.",
      booking: { label: "Rental car", value: "Requested by email", source: "Giourgas — awaiting reply" }, codeKey: "greececars",
    ...
    { date: "2026-10-08", start: "09:45", title: "Drive Pollonia → Adamantas & return the car", type: "transit", fixed: true,
      ...
      note: "Leave Pollonia about 9:45 for a 10:30 drop-off, which is 50 minutes before the boat. Ask Giourgas to take it back at the port rather than the office — they do that at no charge, and it saves a walk with the bags. Fill the tank on the way: the stations are around Adamantas, and there's nothing near the port to fix it at the last minute.",
