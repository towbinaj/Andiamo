...

{
  ...
  events: [
    ...
    { date: "2026-10-08", start: "15:45", title: "Ferry Santorini → Heraklion — SeaJets", type: "transit", fixed: true,
      address: "Athinios Port, Santorini",
      website: "https://www.seajets.com/",
      note: "Arrives Heraklion 5:25 PM — 1 hr 40 min across open sea, the most exposed crossing of the trip and the tail of a six-hour travel day. Go Platinum: €91 against €77 for Club, so €28 more for the two of you, and it buys the quietest room on the ship with service, at the point in the day you'll want it. One caveat — Platinum is usually the top deck, which feels more motion if the sea is up.",
      headsup: ["Connection guaranteed by SeaJets", "Platinum — €14 more each"] },
