...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: "11:30", title: "Drive to Fira, drop the car", type: "transit", fixed: true,
      address: "Fira, Santorini 84700",
      note: "Ten minutes down from Imerovigli, straight after checkout. Handing it back in Fira puts you on the museum's doorstep and saves hunting for parking, which in Fira is its own event. Book the return for 11:30 and the hire stays inside one 24-hour day from the 13:00 pick-up — half an hour later and most agencies bill a second day.",
      headsup: ["Keeps it to a single rental day"] },
