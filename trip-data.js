...

{
  ...
  events: [
    ...
    { date: "2026-10-06", start: "17:30", title: "Pick up the rental car — Avance, Adamantas", type: "transit", fixed: true,
      address: "Avance Rent a Car, Adamantas, Milos 84801",
      website: "https://avance.gr/locations/milos-adamadas-port/",
      note: "Booked with Avance, a Greek chain with a Milos port location — 17:30 Tuesday to 10:30 Thursday, about 41 hours, which bills as two days. Two things to nail down before the day, because a chain is less improvisational than a village firm: that someone is actually at the port at 17:30 in October, and that they have the SeaJets SUPER JET 2 arrival at 17:10 against the booking, so a late ferry doesn't find a locked desk. Ask for the Suzuki Ignis automatic or similar: barely longer than a Panda, so it parks in Plaka and on the Klima descent, a little higher off the ground for the beach approach roads, and an automatic for the steep single-track. The 4x4s solve a problem you don't have — the rough tracks are in the far west and the contract voids your insurance on unpaved roads anyway.",
      booking: { label: "Rental car", value: "Booked · Avance", source: "details to add" }, codeKey: "greececars",
      headsup: ["Confirm someone is at the port at 17:30", "Give them the ferry — SUPER JET 2, 17:10"] },
    ...
    { date: "2026-10-08", start: "09:45", title: "Drive Pollonia → Adamantas & return the car", type: "transit", fixed: true,
      ...
      note: "Leave Pollonia about 9:45 for a 10:30 drop-off, which is 50 minutes before the boat. Check where Avance want it back — at the port is what you want, since you'll already be standing there for the 11:20 sailing, and an office drop means a walk with the bags. Fill the tank on the way: the stations are around Adamantas, and there's nothing near the port to fix it at the last minute.",
